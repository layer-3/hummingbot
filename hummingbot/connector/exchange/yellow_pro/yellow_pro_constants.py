...
REST_URLS = {
    PRODUCTION_DOMAIN: "https://api.staging.yellow.pro.yellow_pro.app",
}

AUTH_URLS = {
    PRODUCTION_DOMAIN: "https://auth.staging.yellow.pro.yellow_pro.app",
}

QUOTE_URLS = {
    PRODUCTION_DOMAIN: "https://quotes.staging.yellow.pro.yellow_pro.app",
}

WS_URLS = {
    PRODUCTION_DOMAIN: "wss://api.staging.yellow.pro.yellow_pro.app/ws",
}
